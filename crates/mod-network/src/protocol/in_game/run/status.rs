...
use crate::{
    components::{
        BigEndian, InGamePlayerStatusPullData, ObjectId, MAX_IN_GAME_BULLETS, MAX_IN_GAME_PLAYERS,
    },
...
impl InGameStatusPacket {
    ...
    ///
    pub fn new(players: Vec<InGamePlayerStatusPullData>, removed_bullets: Vec<ObjectId>) -> Self {
...
mod tests {
    ...
    fn test_in_game_status_packet() {
        ...
        let origin = InGameStatusPacket::new(players, removed_bullets);
