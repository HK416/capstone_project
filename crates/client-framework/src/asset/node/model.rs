...
impl Into<PlayMode> for WrapMode {
    #[inline]
    fn into(self) -> PlayMode {
        match self {
            WrapMode::Once => PlayMode::Once, 
            WrapMode::Loop => PlayMode::Loop, 
            WrapMode::Pingpong => PlayMode::Pingpong { is_reverse: false }, 
        }
    }
}
