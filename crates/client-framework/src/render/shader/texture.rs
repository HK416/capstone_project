...
use crate::render::material::MaterialComponent;
use crate::render::mesh::Attribute;
use crate::render::mesh::MeshComponent;
use crate::render::object::GameObject;
use crate::render::object::GameObjectComponent;
use crate::render::skin::Skin;
use crate::render::skin::SkinComponent;
...
impl TextureShader {
    ...
    fn draw_mesh<'a>(
        ...
        let mut query = world.query::<QueryMesh>().with::<&TextureShader>().without::<&SkinComponent>();
    ...
    fn draw_skinned_mesh<'a>(
        ...
        let mut query = world.query::<QuerySkinMesh>().with::<&TextureShader>();
...
/// 스키닝된 메쉬의 텍스처 쉐이더입니다.
#[derive(Debug)]
pub struct SkinMeshTextureShader;
