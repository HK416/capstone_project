...
use mod_network::components::{
    MAX_IN_GAME_PLAYERS, ObjectId, Permission, Team, UserId, UserName, WorldId,
};
...
impl GameWorld {
    ...
    //         // 새로운 플레이어를 생성하고 게임 월드 플레이어 집합에 추가합니다.
    //         let new_player =
    //             PlayerObject::new(UserAccount::new(uid, name), Permission::User, Team::Red);
    //         self.players.insert(uid, new_player);
    //     } else {
    //         // 게임 월드 세션 집합에 세션을 추가합니다.
    //         self.sessions.insert(session.clone(), uid);
    ...
    //         // 새로운 플레이어를 생성하고 게임 월드 플레이어 집합에 추가합니다.
    //         let new_player =
    //             PlayerObject::new(UserAccount::new(uid, name), Permission::User, Team::Blue);
    //         self.players.insert(uid, new_player);
    //     }
