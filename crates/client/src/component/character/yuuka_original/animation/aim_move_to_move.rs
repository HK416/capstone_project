//! 캐릭터 모델의 `AimMoveToMove` 애니메이션과 관련된 코드를 관리합니다.
//!
...
///
pub fn animate_character_when_aim_move_to_move<Tag: Copy + Component>(
    ...
    let motion = motions
        .get(ATTACK_END_ANIMATION)
        .expect("no such animation data!");

    // 애니메이션 키 프레임을 샘플링합니다.
    let time_point_0 = action_state_timer
        .0
        .min(character_attributes.normal_attack_end_duration);
    ...
    let offset = 1.0 - time_point_0 as f32 / character_attributes.normal_attack_end_duration as f32;
