//! 캐릭터 모델의 `AttackJumping` 애니메이션과 관련된 코드를 관리합니다.
//!
...
///
pub fn animate_character_when_attack_jumping<Tag: Copy + Component>(
    ...
    let time_point_0 = action_state_timer
        .0
        .min(character_attributes.normal_attack_ing_duration);
