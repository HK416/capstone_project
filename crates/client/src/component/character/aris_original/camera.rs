//! `Aris_Original` 모델의 카메라 설정과 관련된 코드를 관리합니다.
//!
...
pub const CAMERA_ZOOM_REL_POS: glam::Vec3A = glam::vec3a(0.25, 0.7, 0.5);
...
fn attack_wave_camera_effect(
    ...
    const TIME_POINT_1: u16 = 1000;
    const TIME_POINT_2: u16 = 1500;
    const WAVE_OFFSET: f32 = 10f32.to_radians();
