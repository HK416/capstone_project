//! 캐릭터 모델의 `MoveToAimMove` 애니메이션과 관련된 코드를 관리합니다.
//!
...
///
pub fn animate_character_when_move_to_aim_move<Tag: Copy + Component>(
    ...
    let motion = motions
        .get(ATTACK_START_ANIMATION)
        .expect("no such animation data!");

    // 애니메이션 키 프레임을 샘플링합니다.
    let time_point_0 = action_state_timer
        .0
        .min(character_attributes.normal_attack_start_duration);
    ...
    let offset = time_point_0 as f32 / character_attributes.normal_attack_start_duration as f32;
