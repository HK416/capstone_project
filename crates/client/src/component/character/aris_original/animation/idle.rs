//! 캐릭터 모델의 `Idle` 애니메이션과 관련된 코드를 관리합니다.
//!
...
///
pub fn animate_character_when_idle<Tag: Copy + Component>(
    ...
    // 애니메이션 키 프레임을 샘플링합니다.
    let time_point_0 = action_state_timer.get() % character_attribute.normal_idle_duration;
