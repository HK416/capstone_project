//! 캐릭터 모델의 `VictoryStart` 애니메이션과 관련된 코드를 관리합니다.
//!
...
///
pub fn animate_character_when_victory_start<Tag: Copy + Component>(
    ...
    let time_point_0 = action_state_timer
        .0
        .min(character_attribute.victory_start_duration);
