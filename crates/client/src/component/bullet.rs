...
use crate::{
    ...
    component::{ToParentTrans, WorldTransform},
};

use super::{Child, Parent, Sibling};
...
pub fn spwan_bullet(
    ...
    const FUNC_TABLE: [SpawnFn; NUM_BULLETS] = [spawn_common_bullet_model];
...
fn spawn_common_bullet_model(
    ...
    const MODEL_NAME: &'static str = "Bullet_01_Warhead";
