...
// use crate::{
//     component::{
//         CameraTag, CharacterInvMass, ControllerState, FocusState, MaxCharacterSpeed, MoveDirection,
...
//             direction: MoveDirection(glam::Vec4::new(0.0, 0.0, 1.0, 0.0)),
...
//             .expect("user configuration must exist");
//         self.focus_state
//             .update_when_mouse_btn_pressed(&user_config, button);
//         Ok(())
//     }
...
//             .expect("user configuration must exist");
//         self.focus_state
//             .update_when_mouse_btn_released(&user_config, button);
//         Ok(())
//     }
