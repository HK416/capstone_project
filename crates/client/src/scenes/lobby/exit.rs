...
use crate::{
    asset::{
        ARONA_SAD_URI, NOTOSANS_BOLD, NOTOSANS_REGULAR, SoundDataPool, TexturePool,
        TextureViewPool, UI_BUTTON_BACK, UI_BUTTON_TOUCH, UI_NOTICE,
    },
    component::ButtonState,
    config::{Locale, NUM_LOCALE},
    scenes::{
        BASE_WIDTH, ERR_CLOSED_MSG_TEXTS, ERR_IO_MSG_TEXTS, ERR_NETWORK_TITLE_TEXTS, FONT_COLOR,
        FatalErrorSceneLayer, NEG_COLOR, NEG_FOCUS_COLOR, NORM_COLOR, NORM_EXP_COLOR,
        NORM_FOCUS_COLOR,
    },
};
