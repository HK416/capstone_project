...
use crate::{
    ...
    config::Locale,
    scenes::{BASE_WIDTH, FONT_COLOR, NORM_COLOR, NORM_FOCUS_COLOR, POSI_COLOR, POSI_FOCUS_COLOR},
};
...
impl LobbyControlOptionModalLayer {
    ...
    fn draw_common_opt_menu(
        ...
        let size = egui::vec2(MENU_WIDTH, CONTENT_HEIGHT) * scale;
    ...
    /// 컨텐츠를 그립니다.
    fn draw_content(&mut self, ui: &mut egui::Ui, i: usize, scale: f32) {}
...
impl GameScene for LobbyControlOptionModalLayer {
    ...
    fn ui_callback(&mut self, window: &Window, app: &dyn AppHandle) {
        ...
        egui::Modal::new(egui::Id::new("Option_Modal"))
            .frame(frame)
            ...
            .show(ctx, |ui| {
                ...
                ui.vertical_centered(|ui| {
                    ...
                    let beg =
                        egui::pos2(center.x + (MENU_WIDTH - 0.5 * MODAL_WIDTH) * scale, beg_y);
                    let end =
                        egui::pos2(center.x + (MENU_WIDTH - 0.5 * MODAL_WIDTH) * scale, end_y);
                    ui.painter().line_segment(
                        [beg, end],
