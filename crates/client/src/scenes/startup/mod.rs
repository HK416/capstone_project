...
use crate::{
    asset::{
        BG_GROWTH_EFFECT_LABEL_DATA, BG_GROWTH_EFFECT_LABEL_URI, BG_LOGIN_TITLE_0_DATA,
        BG_LOGIN_TITLE_0_URI, BG_LOGIN_TITLE_1_DATA, BG_LOGIN_TITLE_1_URI, BG_LOGIN_TITLE_2_DATA,
        BG_LOGIN_TITLE_2_URI, BG_LOGIN_TITLE_3_DATA, BG_LOGIN_TITLE_3_URI, BG_LOGIN_TITLE_4_DATA,
        BG_LOGIN_TITLE_4_URI, BG_LOGIN_TITLE_5_DATA, BG_LOGIN_TITLE_5_URI, BG_SOUND_THEME_01,
        BG_SOUND_THEME_01_DATA, BG_SOUND_THEME_31, BG_SOUND_THEME_31_DATA, CV_ARIS_TITLE_DATA,
        CV_MIDORI_TITLE_DATA, CV_MOMOI_TITLE_DATA, CV_SOUND_TITLE, CV_YUUKA_OPTION,
        CV_YUUKA_OPTION_DATA, CV_YUUKA_TITLE_DATA, DecodedSound, GAME_LOGO_DATA, GAME_LOGO_URI,
        ...
        HUD_OPTION_ICON_DATA, HUD_OPTION_ICON_URI, NOTOSANS_BOLD, NOTOSANS_REGULAR, SoundDataPool,
        TexturePool, UI_BUTTON_BACK, UI_BUTTON_BACK_DATA, UI_BUTTON_TOUCH, UI_BUTTON_TOUCH_DATA,
        UI_LOADING, UI_LOADING_DATA, UI_NOTICE, UI_NOTICE_DATA, UI_PAUSE, UI_PAUSE_DATA,
        UI_TURN_DOWN, UI_TURN_DOWN_DATA, UI_TURN_UP, UI_TURN_UP_DATA, USER_CONFIG,
    },
    component::{
        ...
        HaloOutlineRenderPipeline, HaloRenderPipeline, SHADOW_FORMAT, SkyboxRenderPipeline,
        StageBakePipeline, StageBarrierRenderPipeline, StageRenderPipeline, TreeRenderPipeline,
    },
    config::UserConfig,
};
...
impl GameStartupScene {
    ...
    fn init_render_pipeline(&mut self, thread_pool: &ThreadPool, device: &Arc<wgpu::Device>) {
        ...
        // 방어막 파티클 이펙트를 그리는 렌더링 파이프라인을 생성합니다.
        let device_cloned = device.clone();
        let task_results = self.task_results.clone();
        thread_pool.spawn(move || {
