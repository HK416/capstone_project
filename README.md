...
# 전체 프로젝트 컴파일 방법
## 방법 1. (Windows 만 실행 가능)
프로젝트 디렉토리 내 `build-release.bat`파일을 실행하면 `release` 모드로 `client`와 `server`를 컴파일 후 바로가기를 생성합니다.
...
<b>게임 타이틀</b> - Hello 2 Halo </br>
<b>게임 장르</b> - TPS 팀플레이 히어로 슈팅 </br>
<b>플레이 인원</b> - 2인 - 10인 </br>
...
|CPU|SSE4.1 명령어 지원 x86_64 아키텍처|Neon 명령어 지원 Apple Silicon|Web Assembly SIMD 지원 브라우저 및 하드웨어|
